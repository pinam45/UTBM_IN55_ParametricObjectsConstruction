...
\begin{document}
	...
	\begin{tikzpicture}[x=1pt,y=1pt,>=Latex]
		...
		%---------------------------------
		% Zones
		\fill[triangleface] (P7) -- (P8) -- (P3) -- cycle;
		\fill[squareface] (P3) -- (P8) -- (P4) -- (P0) -- cycle;
		\fill[squareface] (P0) -- (P4) -- (P5) -- (P1) -- cycle;
		\fill[squareface] (P0) -- (P4) -- (P5) -- (P1) -- cycle;
		\fill[squareface] (P5) -- (P1) -- (P2) -- (P6) -- cycle;
		\fill[squareface] (P6) -- (P2) -- (P3) -- (P7) -- cycle;
		...
		\draw[squaresplitline] (P2) -- (P7);
		\draw[squaresplitline] (P1) -- (P6);
		\draw[squaresplitline] (P1) -- (P4);
		\draw[squaresplitline] (P0) -- (P8);
