			...
			\paragraph*{}
				...
				\begin{minipage}[c]{0.59\textwidth}
					\begin{figure}[H]
						...
						\hfill \\
						Chaque Layer correspond à un polygone configurable, le bouton \fbox{\texttt{Randomize}} permet de générer des valeures de configuration aléatoire pour le layer.\\
						\hfill \\
