...
\begin{document}
	...
	\section{TODO}
		...
		\begin{figure}[H]
			\centering%
			\includegraphics[width=0.32\textwidth]{face_1_1}%
			\includegraphics[width=0.32\textwidth]{face_1_2}%
			\includegraphics[width=0.32\textwidth]{face_1_3}%
		...
		\begin{figure}[H]
			\centering%
			\includegraphics[width=0.32\textwidth]{face_2_1}%
			\includegraphics[width=0.32\textwidth]{face_2_2}%
			\includegraphics[width=0.32\textwidth]{face_2_3}%
